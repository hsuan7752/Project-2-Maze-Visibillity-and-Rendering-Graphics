...
class MazeWindow : public Fl_Gl_Window {
	...
	public:
		...
		float*	LookAt(float eyeX, float eyeY, float eyeZ, float centerX, float centerY, float centerZ, float upX, float upY, float upZ);
		...
		float* TransformationMatrix(float* matrix);
